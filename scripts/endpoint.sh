...
echo \{\"server_version\":\"1.00\",\"id\":\"1\",\"environment\":\"$npm_config_env\",\"server\":\"$npm_config_server\",\"userid\":\"$npm_config_userid\",\"password\":\"$npm_config_password\",\"notificationserver\":\"$npm_config_notificationserver\",\"notificationkey\":\"$npm_config_notificationkey\",\"key2\":\"$npm_config_key2\",\"iv2\":\"$npm_config_iv2\"\} > src/config.json
